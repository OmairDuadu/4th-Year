...
drop index ix_employees_dob_btree;
drop index ix_employees_dob_hash;
drop index ix_employees_last_name;
...
explain select * from employees where last_name = 'Duadu';

select * from employees where date_of_birth = '1978-07-26';

explain analyze select * from employees where date_of_birth > '1978-07-26';

explain analyze select * from employees where last_name = 'Duadu';

create index ix_employees_last_name on employees using btree (last_name);


select * from employees where last_name = 'Duadu';
